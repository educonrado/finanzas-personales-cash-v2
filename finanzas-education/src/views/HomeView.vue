<template>
  <div class="container mx-auto p-4">
    <div class="mt-8">
      <router-link to="/login" class="text-blue-500 underline">Login<span aria-hidden="true">&rarr;</span></router-link>
    </div>
  </div>
    ...
    <div class="grid  gap-12 grid-cols-1">
      <div class="flex flex-col ">
        <div class="flex flex-col sm:flex-row items-center">
          <h2 class="font-semibold text-lg mr-auto">Transacciones</h2>
          <div class="w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0"></div>
        </div>
        <div class="mt-5">
          <div class="form">
            <div class="md:space-y-2 mb-3">
              <label class="text-gray-600 py-2">Agregar o editar informaci&oacute;n de transacciones personales.</label>
            </div>
            <div class="md:flex flex-row md:space-x-4 w-full text-xs">
              <div class="mb-3 space-y-2 w-full text-xs">
                ...
                <input placeholder="Company Name"
                  ...
                  required type="text" name="integration[shop_name]" id="integration_shop_name">
            ...
            <div class="md:flex md:flex-row md:space-x-4 w-full text-xs">
              ...
              <div class="w-full flex flex-col mb-3">
                ...
                <select
                  ...
                  required name="integration[city_id]" id="integration_city_id">
