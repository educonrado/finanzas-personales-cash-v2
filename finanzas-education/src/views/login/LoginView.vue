<template>
  <div class="h-screen flex flex-col items-center justify-center bg-gray-900">
    <div class="text-center mb-8">
      ...
      <h1 class="text-4xl font-bold text-white">Finanzas Education</h1>
    </div>
    ...
    <div class="absolute bottom-4 text-center text-gray-400 text-sm">
      <p>Al continuar, aceptas nuestros <a href="#" class="underline">Términos de Servicio</a> y <a href="#"
          class="underline">Política de Privacidad</a>.</p>
    </div>
  </div>
</template>
<script lang="ts" setup>
import { loginWithGoogle } from '@/services/auth/AuthGoogle';
